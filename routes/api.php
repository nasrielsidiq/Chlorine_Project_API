...
use App\Http\Controllers\API\PDFGenerateController;
use App\Http\Controllers\API\StudentController;
use App\Http\Middleware\AuthJWTToken;
...
Route::middleware(AuthJWTToken::class)->group(function () {
    ...
    Route::get('/certificate', [PDFGenerateController::class, 'get']);
});
